...
const tools = [
    ...
    },
    {
        ...
        description: "React JS is Javascript library",
        url: 'https://reactjs.org',
    },
    {
        name: 'Vue JS',
        icon: '/images/tools/vue.svg',
        description: 'Vue JS is Javascript frameworks',
        url: 'https://vuejs.org',
    },
    {
        name: 'Jquery',
        icon: '/images/tools/jquery.svg',
        description: 'Jquery is Javascript frameworks',
        url: 'https://jquery.com',
    },
    {
        name: 'Bootstrap',
        icon: '/images/tools/bootstrap.svg',
        description: 'Bootstrap is CSS frameworks',
        url: 'https://getbootstrap.com',
    },
    {
        name: 'Tailwind',
        icon: '/images/tools/tailwind.svg',
        description: 'Tailwind is CSS frameworks',
        url: 'https://tailwindcss.com',
    },
    {
        name: 'Figma',
        icon: '/images/tools/figma.svg',
        description: 'Figma for Design',
